...
/**
 * An extension of android's native {@link ImageView} supporting pinch-zoom, double-tap-zoom and exploring the image via drag-gestures.
 */
public class MultiTouchImageView extends StretchedImageView
{
	...
	/**
	 * The image's initial (after {@link #onMeasure(int, int)} was performed) state array representation.
	 */
	 ...
	 *
	 * @return <code>true</code> if the current image matrix' scale has been adjusted to the initial matrix' scale. <code>false</code> if the
	...
	/**
	 * Moves the image from its current position. This method does not accept absolute coordinates. The movement has to be specified via
	 * relative delta values.
	 *
	 * @param deltaX The amount of pixels to move the image on the X-axis.
	 * @param deltaY The amount of pixels to move the image on the Y-axis.
	 */
	public void translate( float deltaX, float deltaY )
	{
		matrixValues[Matrix.MTRANS_X] = getTranslation( Axis.X,
		...
		matrixValues[Matrix.MTRANS_Y] = getTranslation( Axis.Y,
	...
	public void scale( float scale, float x, float y )
	{
		...
		translate( scaleMatrixValues[Matrix.MTRANS_X] - matrixValues[Matrix.MTRANS_X],
